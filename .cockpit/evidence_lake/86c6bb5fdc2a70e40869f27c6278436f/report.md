...
╰──────────────────────────────────────╯
Scanning directory: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_37gn5_zw/agent-aws
...
ACTION: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_37gn5_zw/agent-aws/agent.py | 
...
ACTION: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_37gn5_zw/agent-aws/agent.py | Tone 
...
/var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_37gn5_zw/agent-aws...
...
┡━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━┩
│ Total Requests   │ 50           │ -             │
│ Throughput (RPS) │ 467.04 req/s │ > 5.0         │
│ Success Rate     │ 100.0%       │ > 99%         │
│ Avg Latency      │ 0.107s       │ < 2.0s        │
│ Est. TTFT        │ 0.032s       │ < 0.5s        │
│ p90 Latency      │ 0.490s       │ < 3.5s        │
│ Total Errors     │ 0            │ 0             │
└──────────────────┴──────────────┴───────────────┘
...
│                                                                                                        │
│ ╭────────────────────────────────────────────── locals ──────────────────────────────────────────────╮ │
│ │       fut = <Future at 0x117213f80 state=finished raised RetryError>                               │ │
│ │ retry_exc = RetryError(<Future at 0x117213f80 state=finished raised RetryError>)                   │ │
│ │        rs = <RetryCallState 4681865584: attempt #3; slept for 8.0; last result: failed (RetryError │ │
│ │             RetryError[<Future at 0x117213e00 state=finished raised AttributeError>])>             │ │
│ │      self = <Retrying object at 0x1170f9c70 (stop=<tenacity.stop.stop_after_attempt object at      │ │
│ │             0x1170f96a0>, wait=<tenacity.wait.wait_exponential object at 0x1170f9670>,             │ │
│ │             sleep=<function sleep at 0x111da4ae0>, retry=<tenacity.retry.retry_if_exception_type   │ │
│ │             object at 0x111d9ec60>, before=<function before_nothing at 0x111da6660>,               │ │
│ │             after=<function after_nothing at 0x111da68e0>)>                                        │ │
│ ╰────────────────────────────────────────────────────────────────────────────────────────────────────╯ │
╰────────────────────────────────────────────────────────────────────────────────────────────────────────╯
RetryError: RetryError[<Future at 0x117213f80 state=finished raised RetryError>]
...
┡━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━┩
│  1   │           89.0% │     100.0% │       0.54 Q/kTok │ PEAK FOUND │ +14.0% │
│  2   │           88.9% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.1% │
│  3   │           89.1% │     100.0% │       0.54 Q/kTok │ PEAK FOUND │  +0.1% │
│  4   │           88.7% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.4% │
│  5   │           89.3% │     100.0% │       0.54 Q/kTok │ PEAK FOUND │  +0.2% │
│  6   │           89.2% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.1% │
│  7   │           90.2% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.9% │
└──────┴─────────────────┴────────────┴───────────────────┴────────────┴────────┘
