...
╰──────────────────────────────────────╯
Scanning directory: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_ewj7pzmb/agent-aws
...
ACTION: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_ewj7pzmb/agent-aws/agent.py | 
...
ACTION: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_ewj7pzmb/agent-aws/agent.py | Tone 
...
/var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_ewj7pzmb/agent-aws...
...
┡━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━┩
│ Total Requests   │ 50           │ -             │
│ Throughput (RPS) │ 581.56 req/s │ > 5.0         │
│ Success Rate     │ 100.0%       │ > 99%         │
│ Avg Latency      │ 0.086s       │ < 2.0s        │
│ Est. TTFT        │ 0.026s       │ < 0.5s        │
│ p90 Latency      │ 0.299s       │ < 3.5s        │
│ Total Errors     │ 0            │ 0             │
└──────────────────┴──────────────┴───────────────┘
...
┡━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━┩
│  1   │           89.8% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │ +14.8% │
│  2   │           89.8% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.0% │
│  3   │           89.2% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.6% │
│  4   │           89.9% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.1% │
│  5   │           89.2% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.8% │
│  6   │           90.4% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.4% │
└──────┴─────────────────┴────────────┴───────────────────┴────────────┴────────┘
...
│                                                                                                        │
│ ╭────────────────────────────────────────────── locals ──────────────────────────────────────────────╮ │
│ │       fut = <Future at 0x129213e30 state=finished raised RetryError>                               │ │
│ │ retry_exc = RetryError(<Future at 0x129213e30 state=finished raised RetryError>)                   │ │
│ │        rs = <RetryCallState 4984905968: attempt #3; slept for 8.0; last result: failed (RetryError │ │
│ │             RetryError[<Future at 0x129213e90 state=finished raised AttributeError>])>             │ │
│ │      self = <Retrying object at 0x1291f9e20 (stop=<tenacity.stop.stop_after_attempt object at      │ │
│ │             0x1291f9850>, wait=<tenacity.wait.wait_exponential object at 0x1291f9820>,             │ │
│ │             sleep=<function sleep at 0x1071a4ae0>, retry=<tenacity.retry.retry_if_exception_type   │ │
│ │             object at 0x10719f200>, before=<function before_nothing at 0x1071a6660>,               │ │
│ │             after=<function after_nothing at 0x1071a68e0>)>                                        │ │
│ ╰────────────────────────────────────────────────────────────────────────────────────────────────────╯ │
╰────────────────────────────────────────────────────────────────────────────────────────────────────────╯
RetryError: RetryError[<Future at 0x129213e30 state=finished raised RetryError>]
