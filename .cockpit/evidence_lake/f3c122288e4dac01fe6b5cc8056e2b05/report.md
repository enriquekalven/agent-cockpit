...
**Timestamp**: 2026-02-16 13:10:10
**Status**: ❌ FAIL

---
✅ **SME Verdict**: All governance gates APPROVED. No critical architectural mismatches detected.
...
**Current Score**: 87.5% | **Previous Score**: 0.0% | **Change**: +87.5% ↑
...
╰──────────────────────────────────────╯
Scanning directory: /Users/enriq/Documents/git/agent-cockpit/test-adk-agent
...
```text
ce TCO: LOW (Based on 1M token utilization curve).                  │
...
/Users/enriq/Documents/git/agent-cockpit/test-adk-agent...
...
┡━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━┩
│ Total Requests   │ 50           │ -             │
│ Throughput (RPS) │ 605.74 req/s │ > 5.0         │
│ Success Rate     │ 0.0%         │ > 99%         │
│ Avg Latency      │ 0.083s       │ < 2.0s        │
│ Est. TTFT        │ 0.025s       │ < 0.5s        │
│ p90 Latency      │ 0.308s       │ < 3.5s        │
│ Total Errors     │ 50           │ 0             │
└──────────────────┴──────────────┴───────────────┘
...
│   417 │   │   │   return                                                                │
╰─────────────────────────────────────────────────────────────────────────────────────────╯
RetryError: RetryError[<Future at 0x11c0c7e60 state=finished raised Exit>]
