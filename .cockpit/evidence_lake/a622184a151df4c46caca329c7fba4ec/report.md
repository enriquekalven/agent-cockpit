...
╰──────────────────────────────────────╯
Scanning directory: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_37gn5_zw/agent-google
...
ACTION: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_37gn5_zw/agent-google/agent.py | 
...
┡━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━┩
│ Total Requests   │ 50           │ -             │
│ Throughput (RPS) │ 844.79 req/s │ > 5.0         │
│ Success Rate     │ 100.0%       │ > 99%         │
│ Avg Latency      │ 0.059s       │ < 2.0s        │
│ Est. TTFT        │ 0.018s       │ < 0.5s        │
...
/var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_37gn5_zw/agent-google...
...
┡━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━┩
│  1   │           90.6% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │ +15.6% │
└──────┴─────────────────┴────────────┴───────────────────┴────────────┴────────┘

✅ SUCCESS: High-fidelity agent stabilized at the 90.6% quality peak.
...
│                                                                                                        │
│ ╭────────────────────────────────────────────── locals ──────────────────────────────────────────────╮ │
│ │       fut = <Future at 0x10ad13a40 state=finished raised RetryError>                               │ │
│ │ retry_exc = RetryError(<Future at 0x10ad13a40 state=finished raised RetryError>)                   │ │
│ │        rs = <RetryCallState 4476024592: attempt #3; slept for 8.0; last result: failed (RetryError │ │
│ │             RetryError[<Future at 0x10ad12ba0 state=finished raised AttributeError>])>             │ │
│ │      self = <Retrying object at 0x10acf9a30 (stop=<tenacity.stop.stop_after_attempt object at      │ │
│ │             0x10acf97f0>, wait=<tenacity.wait.wait_exponential object at 0x10acf97c0>,             │ │
│ │             sleep=<function sleep at 0x109aa4ae0>, retry=<tenacity.retry.retry_if_exception_type   │ │
│ │             object at 0x109a9f140>, before=<function before_nothing at 0x109aa6660>,               │ │
│ │             after=<function after_nothing at 0x109aa68e0>)>                                        │ │
│ ╰────────────────────────────────────────────────────────────────────────────────────────────────────╯ │
╰────────────────────────────────────────────────────────────────────────────────────────────────────────╯
RetryError: RetryError[<Future at 0x10ad13a40 state=finished raised RetryError>]
