...
- **Missing Branding (Logo) or SEO Metadata (OG/Description)**: Add meta
...
+ Reduces context window waste and improves reasoning focus.
   ```
1. **Secret Leak**
   - 📍 Location: `"output": " config.py`
   - ✨ Recommended Fix: Use Secret Manager."
   - 📝 **Architectural Diff**:
   ```diff
- # Legacy or Inefficient Logic
+ # Secret Leak
...
1. **Reliability Failure**
   - 📍 Location: `"output": " tests/test_agent.py`
   - ✨ Recommended Fix: Fix failing
   - 📝 **Architectural Diff**:
   ```diff
- # Legacy or Inefficient Logic
+ # Reliability Failure
...
+ Add 'surfaceId' prop to the root
   ```
1. **Missing Branding (Logo) or SEO Metadata (OG/Description)**
   - 📍 Location: `src/App.tsx:1`
   - ✨ Recommended Fix: Add meta
   - 📝 **Architectural Diff**:
   ```diff
- # Legacy or Inefficient Logic
...
+ Enables swarm interoperability and standardized tool-use.
   ```
1. **Reflection Blindness: Brittle Intelligence**
   - 📍 Location: `/Users/enriq/Documents/git/agent-cockpit/src/agent_ops_cockpit/telemetry.py:1`
   - ✨ Recommended Fix: Significantly reduces reasoning hallucinations and logic errors.
...
+ Increases successful task completion rates on open-ended goals.
   ```
1. **Passive Retrieval: Context Drowning**
   - 📍 Location: `/Users/enriq/Documents/git/agent-cockpit/src/agent_ops_cockpit/telemetry.py:1`
   - ✨ Recommended Fix: Reduces context window waste and improves reasoning focus.
...
┡━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━┩
│ Total Requests   │ 50           │ -             │
│ Throughput (RPS) │ 969.20 req/s │ > 5.0         │
│ Success Rate     │ 100.0%       │ > 99%         │
│ Avg Latency      │ 0.052s       │ < 2.0s        │
│ Est. TTFT        │ 0.015s       │ < 0.5s        │
│ p90 Latency      │ 0.210s       │ < 3.5s        │
│ Total Errors     │ 0            │ 0             │
└──────────────────┴──────────────┴───────────────┘
...
nd project    │
│                             │ (OG/Description)            │ logo.                       │
│ src/a2ui/components/lit-co… │ Missing 'surfaceId' mapping │ Add 'surfaceId' prop to the │
│                             │                             │ root component or exported  │
│                             │                             │ interface.                  │
│ src/docs/DocPage.tsx:1      │ Missing 'surfaceId' mapping │ Add 'surfaceId' prop to the │
│                             │                             │ root component or exported  │
│                             │                             │ interface.                  │
│ src/docs/DocLayout.tsx:1    │ Missing 'surfaceId' mapping │ Add 'surfaceId' prop to the │
│                             │                             │ root component or exported  │
│                             │                             │ interface.                  │
│ src/docs/DocHome.tsx:1      │ Missing 'surfaceId' mapping │ Add 'surfaceId' prop to the │
│                             │                             │ root component or exported  │
│                             │                             │ interface.                  │
│ src/components/ReportSampl… │ Missing 'surfaceId' mapping │ Add 'surfaceId' prop to the │
│                             │                             │ root component or exported  │
│                             │                             │ interface.                  │
│ src/components/FlightRecor… │ Missing 'surfaceId' mapping │ Add 'surfaceId' prop to the │
│                             │                             │ root component or exported  │
│                             │                             │ interface.                  │
└─────────────────────────────┴─────────────────────────────┴─────────────────────────────┘
...
┡━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━┩
│  1   │           89.5% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │ +14.5% │
│  2   │           89.5% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.1% │
│  3   │           88.9% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.7% │
│  4   │           89.9% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.3% │
│  5   │           90.1% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.2% │
└──────┴─────────────────┴────────────┴───────────────────┴────────────┴────────┘
...
┡━━━━━━━━╇━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━┩
│ P1     │ 🔥 Security     │ Secret Leak             │ Use Secret Manager.     │
├────────┼─────────────────┼─────────────────────────┼─────────────────────────┤
│ P2     │ 🛡️ Reliability  │ Reliability Failure     │ Fix failing tests.      │
├────────┼─────────────────┼─────────────────────────┼─────────────────────────┤
│ P4     │ 💰 FinOps       │ Context Caching         │ Implement               │
│        │                 │ Opportunity             │ CachingConfig.          │
└────────┴─────────────────┴─────────────────────────┴─────────────────────────┘
...
✨ Final Report generated at test_report.md
