...
╰──────────────────────────────────────╯
Scanning directory: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_ewj7pzmb/agent-azure
...
ACTION: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_ewj7pzmb/agent-azure/agent.py | 
...
/var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_ewj7pzmb/agent-azure...
...
┡━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━┩
│ Total Requests   │ 50           │ -             │
│ Throughput (RPS) │ 652.62 req/s │ > 5.0         │
│ Success Rate     │ 100.0%       │ > 99%         │
│ Avg Latency      │ 0.077s       │ < 2.0s        │
│ Est. TTFT        │ 0.023s       │ < 0.5s        │
│ p90 Latency      │ 0.323s       │ < 3.5s        │
│ Total Errors     │ 0            │ 0             │
└──────────────────┴──────────────┴───────────────┘
...
│  2   │           88.8% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.4% │
│  3   │           88.8% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.4% │
│  4   │           90.2% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +1.0% │
└──────┴─────────────────┴────────────┴───────────────────┴────────────┴────────┘
...
│                                                                                                        │
│ ╭────────────────────────────────────────────── locals ──────────────────────────────────────────────╮ │
│ │       fut = <Future at 0x106e110a0 state=finished raised RetryError>                               │ │
│ │ retry_exc = RetryError(<Future at 0x106e110a0 state=finished raised RetryError>)                   │ │
│ │        rs = <RetryCallState 4410284256: attempt #3; slept for 8.0; last result: failed (RetryError │ │
│ │             RetryError[<Future at 0x106e116a0 state=finished raised AttributeError>])>             │ │
│ │      self = <Retrying object at 0x106df9fa0 (stop=<tenacity.stop.stop_after_attempt object at      │ │
│ │             0x106df99a0>, wait=<tenacity.wait.wait_exponential object at 0x106df9970>,             │ │
│ │             sleep=<function sleep at 0x1057a4ae0>, retry=<tenacity.retry.retry_if_exception_type   │ │
│ │             object at 0x10579f590>, before=<function before_nothing at 0x1057a6660>,               │ │
│ │             after=<function after_nothing at 0x1057a68e0>)>                                        │ │
│ ╰────────────────────────────────────────────────────────────────────────────────────────────────────╯ │
╰────────────────────────────────────────────────────────────────────────────────────────────────────────╯
RetryError: RetryError[<Future at 0x106e110a0 state=finished raised RetryError>]
