...
╰──────────────────────────────────────╯
Scanning directory: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_xf5p6cqr/agent-google
...
ACTION: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_xf5p6cqr/agent-google/agent.py | 
...
/var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_xf5p6cqr/agent-google...
...
┡━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━┩
│ Total Requests   │ 50           │ -             │
│ Throughput (RPS) │ 642.91 req/s │ > 5.0         │
│ Success Rate     │ 100.0%       │ > 99%         │
│ Avg Latency      │ 0.078s       │ < 2.0s        │
│ Est. TTFT        │ 0.023s       │ < 0.5s        │
│ p90 Latency      │ 0.292s       │ < 3.5s        │
│ Total Errors     │ 0            │ 0             │
└──────────────────┴──────────────┴───────────────┘
...
│                                                                                                        │
│ ╭────────────────────────────────────────────── locals ──────────────────────────────────────────────╮ │
│ │       fut = <Future at 0x111713e90 state=finished raised RetryError>                               │ │
│ │ retry_exc = RetryError(<Future at 0x111713e90 state=finished raised RetryError>)                   │ │
│ │        rs = <RetryCallState 4587496000: attempt #3; slept for 8.0; last result: failed (RetryError │ │
│ │             RetryError[<Future at 0x111713e00 state=finished raised AttributeError>])>             │ │
│ │      self = <Retrying object at 0x1116f9e80 (stop=<tenacity.stop.stop_after_attempt object at      │ │
│ │             0x1116f9820>, wait=<tenacity.wait.wait_exponential object at 0x1116f97f0>,             │ │
│ │             sleep=<function sleep at 0x1102a4ae0>, retry=<tenacity.retry.retry_if_exception_type   │ │
│ │             object at 0x11029edb0>, before=<function before_nothing at 0x1102a6660>,               │ │
│ │             after=<function after_nothing at 0x1102a68e0>)>                                        │ │
│ ╰────────────────────────────────────────────────────────────────────────────────────────────────────╯ │
╰────────────────────────────────────────────────────────────────────────────────────────────────────────╯
RetryError: RetryError[<Future at 0x111713e90 state=finished raised RetryError>]
...
│  2   │           89.0% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.2% │
│  3   │           89.4% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.2% │
│  4   │           89.6% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.1% │
│  5   │           90.0% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.4% │
│  6   │           89.4% │     100.0% │       0.55 Q/kTok │ REGRESSION │  -0.6% │
│  7   │           90.0% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.0% │
└──────┴─────────────────┴────────────┴───────────────────┴────────────┴────────┘
