...
╰──────────────────────────────────────╯
Scanning directory: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_37gn5_zw/agent-azure
...
ACTION: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_37gn5_zw/agent-azure/agent.py | 
...
/var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_37gn5_zw/agent-azure...
...
┡━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━┩
│ Total Requests   │ 50           │ -             │
│ Throughput (RPS) │ 656.03 req/s │ > 5.0         │
│ Success Rate     │ 100.0%       │ > 99%         │
│ Avg Latency      │ 0.076s       │ < 2.0s        │
...
│  2   │           89.0% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.6% │
│  3   │           90.3% │     100.0% │       0.55 Q/kTok │ PEAK FOUND │  +0.8% │
└──────┴─────────────────┴────────────┴───────────────────┴────────────┴────────┘
...
│                                                                                                        │
│ ╭────────────────────────────────────────────── locals ──────────────────────────────────────────────╮ │
│ │       fut = <Future at 0x112213c50 state=finished raised RetryError>                               │ │
│ │ retry_exc = RetryError(<Future at 0x112213c50 state=finished raised RetryError>)                   │ │
│ │        rs = <RetryCallState 4599029904: attempt #3; slept for 8.0; last result: failed (RetryError │ │
│ │             RetryError[<Future at 0x112213b30 state=finished raised AttributeError>])>             │ │
│ │      self = <Retrying object at 0x1121f9df0 (stop=<tenacity.stop.stop_after_attempt object at      │ │
│ │             0x1121f97c0>, wait=<tenacity.wait.wait_exponential object at 0x1121f9790>,             │ │
│ │             sleep=<function sleep at 0x106da4ae0>, retry=<tenacity.retry.retry_if_exception_type   │ │
│ │             object at 0x106d9f050>, before=<function before_nothing at 0x106da6660>,               │ │
│ │             after=<function after_nothing at 0x106da68e0>)>                                        │ │
│ ╰────────────────────────────────────────────────────────────────────────────────────────────────────╯ │
╰────────────────────────────────────────────────────────────────────────────────────────────────────────╯
RetryError: RetryError[<Future at 0x112213c50 state=finished raised RetryError>]
