...
╰──────────────────────────────────────╯
Scanning directory: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_xf5p6cqr/agent-azure
...
ACTION: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_xf5p6cqr/agent-azure/agent.py | 
...
/var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_xf5p6cqr/agent-azure...
...
┡━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━┩
│ Total Requests   │ 50           │ -             │
│ Throughput (RPS) │ 800.86 req/s │ > 5.0         │
│ Success Rate     │ 100.0%       │ > 99%         │
│ Avg Latency      │ 0.062s       │ < 2.0s        │
│ Est. TTFT        │ 0.019s       │ < 0.5s        │
│ p90 Latency      │ 0.262s       │ < 3.5s        │
│ Total Errors     │ 0            │ 0             │
└──────────────────┴──────────────┴───────────────┘
...
│                                                                                                        │
│ ╭────────────────────────────────────────────── locals ──────────────────────────────────────────────╮ │
│ │       fut = <Future at 0x121c13f80 state=finished raised RetryError>                               │ │
│ │ retry_exc = RetryError(<Future at 0x121c13f80 state=finished raised RetryError>)                   │ │
│ │        rs = <RetryCallState 4860125136: attempt #3; slept for 8.0; last result: failed (RetryError │ │
│ │             RetryError[<Future at 0x121c13e30 state=finished raised AttributeError>])>             │ │
│ │      self = <Retrying object at 0x121af9c10 (stop=<tenacity.stop.stop_after_attempt object at      │ │
│ │             0x121af9640>, wait=<tenacity.wait.wait_exponential object at 0x121af9610>,             │ │
│ │             sleep=<function sleep at 0x1206a4ae0>, retry=<tenacity.retry.retry_if_exception_type   │ │
│ │             object at 0x12069f5c0>, before=<function before_nothing at 0x1206a6660>,               │ │
│ │             after=<function after_nothing at 0x1206a68e0>)>                                        │ │
│ ╰────────────────────────────────────────────────────────────────────────────────────────────────────╯ │
╰────────────────────────────────────────────────────────────────────────────────────────────────────────╯
RetryError: RetryError[<Future at 0x121c13f80 state=finished raised RetryError>]
...
│  2   │           89.5% │     100.0% │       0.55 Q/kTok │ REGRESSION │  -0.2% │
│  3   │           89.3% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.4% │
│  4   │           89.2% │     100.0% │       0.54 Q/kTok │ REGRESSION │  -0.5% │
│  5   │           89.4% │     100.0% │       0.55 Q/kTok │ REGRESSION │  -0.3% │
│  6   │           89.5% │     100.0% │       0.55 Q/kTok │ REGRESSION │  -0.2% │
│  7   │           91.2% │     100.0% │       0.56 Q/kTok │ PEAK FOUND │  +1.5% │
└──────┴─────────────────┴────────────┴───────────────────┴────────────┴────────┘
