...
╰──────────────────────────────────────╯
Scanning directory: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_ewj7pzmb/agent-google
...
ACTION: /var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_ewj7pzmb/agent-google/agent.py | 
...
/var/folders/s4/ymsyhp4n6y5crdflfss6hxym00tlcj/T/sovereign_sim_ewj7pzmb/agent-google...
...
┡━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━┩
│ Total Requests   │ 50           │ -             │
│ Throughput (RPS) │ 550.41 req/s │ > 5.0         │
│ Success Rate     │ 100.0%       │ > 99%         │
│ Avg Latency      │ 0.091s       │ < 2.0s        │
│ Est. TTFT        │ 0.027s       │ < 0.5s        │
│ p90 Latency      │ 0.395s       │ < 3.5s        │
│ Total Errors     │ 0            │ 0             │
└──────────────────┴──────────────┴───────────────┘
...
│                                                                                                        │
│ ╭────────────────────────────────────────────── locals ──────────────────────────────────────────────╮ │
│ │       fut = <Future at 0x131013ad0 state=finished raised RetryError>                               │ │
│ │ retry_exc = RetryError(<Future at 0x131013ad0 state=finished raised RetryError>)                   │ │
│ │        rs = <RetryCallState 5115977248: attempt #3; slept for 8.0; last result: failed (RetryError │ │
│ │             RetryError[<Future at 0x131013b60 state=finished raised AttributeError>])>             │ │
│ │      self = <Retrying object at 0x130ef9b80 (stop=<tenacity.stop.stop_after_attempt object at      │ │
│ │             0x130ef9580>, wait=<tenacity.wait.wait_exponential object at 0x130ef9550>,             │ │
│ │             sleep=<function sleep at 0x107ca4ae0>, retry=<tenacity.retry.retry_if_exception_type   │ │
│ │             object at 0x107c9f530>, before=<function before_nothing at 0x107ca6660>,               │ │
│ │             after=<function after_nothing at 0x107ca68e0>)>                                        │ │
│ ╰────────────────────────────────────────────────────────────────────────────────────────────────────╯ │
╰────────────────────────────────────────────────────────────────────────────────────────────────────────╯
RetryError: RetryError[<Future at 0x131013ad0 state=finished raised RetryError>]
