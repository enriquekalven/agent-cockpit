...
| `make maturity` | `agent-ops audit-maturity` | **Expertise Matrix**| v2.0.17: High-fidelity expertise/persona dashboard. |
...
| `make deploy-prod` | **Readiness Audit**| (v2.0.17) Full ecosystem-wide production-readiness benchmarking gate. |
