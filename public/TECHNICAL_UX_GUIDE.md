...
## The "Cockpit Experience" Standard (v2.0.10 Sovereign Release Evolution)
...
*   **New in v2.0.10 Sovereign Release**: The agent can now "Query" the UI for available surfaces across the **Model Context Protocol (MCP)** tool ecosystem.
...
| Vector | Legacy Bot UI | v2.0.10 Sovereign Release Cockpit A2UI/AGUI |
| :--- | :--- | :--- |
...
---
*Generated by the AgentOps Cockpit. Cockpit Experience Division (v2.0.10 Sovereign Release).*
