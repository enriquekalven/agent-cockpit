## The "Watchtower Standard" Release (v1.8.4 Stable)

The `make audit` command is the heartbeat of the **AgentOps Cockpit**. From v1.8.4 onwards, we have introduced **Sovereign Hubs**, **Sentinel Anomaly Detection**, and the **Legacy Alias Bridge**.
...
| `ops audit-maturity`| **Maturity Matrix**| v1.8.4: High-fidelity expertise and persona status dashboard. | Displays the Cockpit's expertise levels across frameworks/platforms. |
