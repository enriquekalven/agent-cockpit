...
## The "Cockpit Evolution" Release (v2.0.10 Sovereign Release)
...
| **`deploy`** | **Factory** | `cockpit deploy cockpit` |
...
## 🛠️ v2.0.10 Sovereign Release Cockpit Features
...
Run `make certify` before a production deployment. This validates the **Cockpit Score** across all Persona Lenses and identifies "Unfixable" strategic debt.

---
*Generated by the AgentOps Cockpit Orchestrator. Engineering Governance Division (v2.0.10 Sovereign Release).*
