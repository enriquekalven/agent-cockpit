...
## The "Autonomous SRE" Standard (v1.6.5 Stable)
...
| `make maturity`| **Expertise Matrix**| Displays the Cockpit's SRE competency and persona status (v1.6.5). | `ops audit-maturity` |
