## The "Adversarial SRE" Standard (v1.6.4 Stable)

The `make red-team` command activates the **Red Team Principal**. In v1.6.4, this persona has evolved into an **Adversarial SRE**, focusing on **Reasoning Degradation**, **Automated Regression Tracking**, and systemic safety.
...
| `make red-team` | **Adversarial Probing** | Unleashes simulated attacks against logic filters. | `red_team.py` (v1.6.4: Golden Sets) |
| `make audit` | **Security Baseline** | Daily safe-build check for prompt hygiene. | `audit.py` (v1.6.4: Pre-flight) |
...
---
*Generated by the AgentOps Cockpit Orchestrator. Sovereign Security Division (v1.6.4 Stable).*
