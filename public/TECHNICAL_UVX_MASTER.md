...
## Portable Governance & Automation (v1.6.3 Stable)
...
| `uvx agentops-cockpit audit-maturity`| **Maturity Matrix**| v1.6.3: Expert competency and persona status dashboard. |
...
---
*Generated by the AgentOps Cockpit. Global Automation Division (v1.6.3 Stable).*
