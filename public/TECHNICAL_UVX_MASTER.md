...
## Portable Governance & Automation (v1.4.7 Stable)
...
| `uvx agentops-cockpit audit-maturity`| **Maturity Matrix**| v1.4.7: Expert competency and persona status dashboard. |
...
---
*Generated by the AgentOps Cockpit. Global Automation Division (v1.4.7 Stable).*
