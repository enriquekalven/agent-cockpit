...
## Portable Governance & Automation (v2.0.10 Sovereign Release)
...
| `uvx agentops-cockpit audit maturity`| **Maturity Matrix**| v2.0.10: Expert competency and persona status dashboard. |
...
| :--- | :--- | :--- |
| `uvx agentops-cockpit audit arch`| **Architecture Review**| v2.0.10: Semantic Paradigm Auditor. |
...
| Command | Objective | Flags |
| :--- | :--- | :--- |
| `uvx agentops-cockpit eval red-team` | **Adversarial Audit** | v2.0.10: Brand Safety & Cross-Silo Risk. |
...
---
*Generated by the AgentOps Cockpit. Global Automation Division (v2.0.10 Sovereign Release).*
