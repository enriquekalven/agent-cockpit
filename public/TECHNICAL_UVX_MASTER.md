...
| `uvx agentops-cockpit audit maturity`| **Maturity Matrix**| v2.0.17: Expert competency and persona status dashboard. |
...
| :--- | :--- | :--- |
| `uvx agentops-cockpit audit arch`| **Architecture Review**| v2.0.17: Semantic Paradigm Auditor. |
...
| Command | Objective | Flags |
| :--- | :--- | :--- |
| `uvx agentops-cockpit eval red-team` | **Adversarial Audit** | v2.0.17: Brand Safety & Cross-Silo Risk. |
