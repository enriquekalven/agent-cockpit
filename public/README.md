...
## 🕹️ v1.8.4: The "Watchtower Standard" Release (LATEST)
Evolving into a full Lifecycle Management Platform for AI Agents. See the [**v1.8.4 Release Notes**](/CHANGELOG.md).
...
### 🛡️ Advanced Governance & Discovery (v1.8.4)
...
1. **v1.8.4 Deep System Audit**: Benchmarks models (Gemini 2.0 Pro/Flash) and logic.
