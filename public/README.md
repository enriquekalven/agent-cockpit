# 🕹️ AgentOps Cockpit (v2.0.17 Autonomous Core)
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Cockpit-v2.0.17-10b981?style=for-the-badge" alt="Cockpit v2.0.17" />
...
- **📊 Premium Visual Dashboards**: v2.0.17 introduces AST-aware precision scanning and Vertex AI-style fleet dashboards.
...
## 🗺️ Project Roadmap
- [x] **v2.0.17**: Autonomous Core (GC-Style Reporting, Fleet Dashboard v2, Anomaly Metadata).
- [x] **v2.0.17**: Autonomous Core & Sanitized Signal (AST Scanners, MarkUp Sanitization, SLA Gates).
...
## 🏛️ v2.0.17: The "Autonomous Core" Release
