# RFC: Governance as Code (Cockpit Evolution v2.0.10 Autonomous Core)
Status: IMPLEMENTED (v2.0.10 Autonomous Core)
...
## 🏛️ The GaC Pillars (v2.0.10 Autonomous Core)
...
| Vector | Traditional Policy Engine | v2.0.10 Autonomous Core Cockpit GaC |
| :--- | :--- | :--- |
