...
The **Cockpit** is the mission control for your Cockpit AI agents. While the "Engine" handles reasoning, the Cockpit ensures that reasoning is safe, cost-effective, and verifiably audited.
...
```yaml
entry_point: "src/cockpit_agent.py"
