...
This document is the definitive source of truth for all operational commands available in the **AgentOps Cockpit**. It follows the **Sovereign Hub Hierarchy** and incorporates the v2.0.2 Strategic Paradigm Auditor.
...
| :--- | :--- | :--- |
| `cockpit`| | **Mission Control**: The 'One Command' to manage fleet and project health. |
...
| | `blueprint` | **Modernize**: Generate MCP Server Wrappers for Legacy Tools. |
| **certify**| | **Checklist**: Launch Sovereign Certification (Full Production readiness). |
...
| :--- | :--- | :--- |
| `make audit` | `agentops-cockpit audit report` | Full System Audit. |
| `make apply-fixes`| `agentops-cockpit fix evolve`| Autonomous Remediation. |
| `make arch-review` | `agentops-cockpit audit arch`| Strategy Review. |
...
| `make certify` | `agentops-cockpit certify` | Full Production Certificate. |
...
---
*Generated by the AgentOps Cockpit Orchestrator. Global Governance Division (v2.0.2 Stable).*
