...
def audit(
    ...
    console.print(
        Panel.fit(
            "🎭 [bold blue]FACE AUDITOR: A2UI COMPONENT SCAN[/bold blue]",
            border_style="blue",
        )
    )
    if sim:
                        ...
                        findings.append(
                            {
                                ...
                                "fix": "Add 'surfaceId' prop to the root component or exported interface.",
                            }
                        )
                        ...
                        findings.append(
                            {
                                ...
                                "fix": "Wrap component in A2UIRegistry.registerComponent().",
                            }
                        )
                        ...
                        findings.append(
                            {
                                ...
                                "fix": "Ensure the button calls an agent tool trigger (onTrigger).",
                            }
                        )
                        ...
                        findings.append(
                            {
                                ...
                                "fix": "Implement a Loading state or Skeleton component for agent latency.",
                            }
                        )
                        ...
                        findings.append(
                            {
                                ...
                                "fix": "Add aria-label or alt tags for screen readers and i18n.",
                            }
                        )
                        ...
                        findings.append(
                            {
                                ...
                                "fix": "Add a footer link to the mandatory Privacy Policy / TOS.",
                            }
                        )
                        ...
                        findings.append(
                            {
                                ...
                                "fix": "Add meta tags (og:image, description) and project logo.",
                            }
                        )
