...
def list():
    ...
    console.print(Panel.fit('📦 [bold blue]MCP TOOL STORE: CENTRAL REGISTRY[/bold blue]', border_style='blue'))
...
def install(name: str):
    ...
    console.print(f"🛠️ [bold cyan]Scaffolding integration for '{name}'...[/bold cyan]")
    ...
    console.print(f"✅ [green]Successfully integrated '{name}' in mcp/{name.replace('-', '_')}.py[/green]")
...
def generate_mcp_blueprint(path: str = typer.Option('.', '--path', '-p')):
    ...
    console.print("🔧 [bold blue]Generating MCP Modernization Blueprint...[/bold blue]")
...
"""
    ...
    console.print(f"✨ [bold green]MCP Wrapper generated:[/bold green] {output_path}")
