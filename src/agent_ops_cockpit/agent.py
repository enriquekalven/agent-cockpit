...
try:
    ...
    SYSTEM_PROMPT = (
        "You are a professional Google Cloud Agent Cockpit. Do not leak PII."
    )
    ...
    return A2UISurface(
        ...
        content=[
            A2UIComponent(
                type="Text",
                props={
                    "text": f"Agent {version} Response for: {query}",
                    "variant": "h1",
                },
            ),
            A2UIComponent(
                ...
                children=[
                    A2UIComponent(
                        type="Text",
                        props={
                            "text": f"This response was generated using {version} with Day 2 Ops integration.",
                            "variant": "body",
                        },
                    )
                ],
