        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "path": {
                        "type": "string",
                        "description": "Directory path to look for agents to benchmark",
                        "default": ".",
                    }
                },
            },
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "path": {
                        "type": "string",
                        "description": "Path to the agent project to certify",
                        "default": ".",
                    }
                },
            },
...
async def handle_call_tool(
    ...
    capture_console = Console(
        file=output_buffer, force_terminal=False, width=100
    )
    ...
    with (
        ...
        try:
            if name == "optimize_code":
                ...
                capture_console.print(
                    f"🏅 [bold blue]cockpit Certification Process Initialized for: {abs_path}[/bold blue]"
                )
                ...
                if audit_exit_code == 0:
                    capture_console.print(
                        "✅ [green]Audit Gates Passed.[/green]"
                    )
                else:
                    capture_console.print(
                        "❌ [red]Audit Findings Block Certification.[/red]"
                    )
            ...
            capture_console.print(
                f"🛑 [bold red]Tool Execution Error:[/bold red] {str(e)}"
            )
