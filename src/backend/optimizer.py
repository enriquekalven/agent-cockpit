...
def audit_agent(file_path):
    ...
    """
    print("\n" + "="*50)
    print("🔍  GCP AGENT OPS: OPTIMIZER AUDIT")
    print("="*50)
    ...
    print(f"📊 Token Metrics: ~{token_count:.0f} prompt tokens detected.")
    ...
    for opt in optimizations:
        ...
        while True:
            ...
            if choice in ["", "approve", "y", "yes"]:
                print(f"✅ [APPROVED] queued for deployment.")
                applied += 1
                break
            elif choice in ["reject", "n", "no"]:
                print(f"❌ [REJECTED] skipping optimization.")
                rejected += 1
                break
            else:
    ...
    if applied > 0:
        print("\n🚀 Ready for production. Run 'make deploy-prod' to push changes.")
    else:
