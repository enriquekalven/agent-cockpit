...
📜 Generating ADR: Wisdom Store alignment at 92%`
  },
  {
    ...
    color: '#06b6d4',
    description: 'v2.0.19: RAG Fidelity, Hill Climbing, and full-spectrum test-driven development (aligns with Addy Osmani Code Reviewer & Test Engineer personas).',
    docs: [
...
✨ Quality baseline: High (No hallucinations detected)`
  },
  {
    ...
    icon: <Shield size={24} />,
    color: '#ef4444',
    description: 'v2.0.19: Brand Safety Playbook hardening and adversarial checks (aligns with Addy Osmani Security Auditor persona).',
    docs: [
    ...
    output: `🛡️ RED TEAM: BRAND SAFETY AUDIT v2.0.19
