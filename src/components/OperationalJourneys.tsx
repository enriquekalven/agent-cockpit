...
Ready to roll. Run 'make dev' to start.`
  },
  {
    ...
    icon: <Layout size={24} />,
    color: '#10b981',
    description: 'Design resilient, multi-cloud agentic systems aligned with v2.0.15 Wisdom Store patterns.',
    docs: [
    ...
    output: `🏗️ Starting Architecture Review v2.0.15...
...
📜 Generating ADR: Wisdom Store alignment at 92%`
  },
  {
    ...
    color: '#06b6d4',
    description: 'v2.0.15: RAG Fidelity Auditing, Hill Climbing, and reasoning-based optimization.',
    docs: [
...
✨ Quality baseline: High (No hallucinations detected)`
  },
  {
    ...
    icon: <Shield size={24} />,
    color: '#ef4444',
    description: 'v2.0.15: Brand Safety Playbook hardening against advanced adversarial attacks.',
    docs: [
    ...
    output: `🛡️ RED TEAM: BRAND SAFETY AUDIT v2.0.15
...
Protocol Standard: A2A v2.0.15 compliant.`
  },
  {
    id: 'product',
    name: 'The Visionary',
