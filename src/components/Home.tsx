    ...
    <div className="crew-home" data-surface-id="home-root">
      ...
      <div className="release-banner">
        <div className="banner-content">
          <span className="banner-tag">STABLE v2.0.15</span>
          <span className="banner-text"><b>v2.0.15 Autonomous Core:</b> Autonomous Evolution Hub, Autonomous Core Engine, and MCP Hub 2.0.</span>
