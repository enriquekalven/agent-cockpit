    ...
    <div className="crew-home" data-surface-id="home-root">
      ...
      <div className="release-banner">
        <div className="banner-content">
          <span className="banner-tag">STABLE v1.8.4</span>
          <span className="banner-text"><b>v1.8.4 Strategic Pilot:</b> Strategic Paradigm Auditor for identifying design mismatches (RAG vs NL2SQL).</span>
