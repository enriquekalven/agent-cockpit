...
export function Home() {
  ...
  const commands = [
    { cmd: 'uvx agentops-cockpit evolve', desc: 'Evolution Hub: Autonomously refactor and upgrade your legacy AI agents in seconds.' },
    ...
    <div className="crew-home" data-surface-id="home-root">
      ...
      <div className="release-banner">
        <div className="banner-content">
          <span className="banner-tag">STABLE v2.0.35</span>
          <span className="banner-text"><b>v2.0.35 Master Architect Edition:</b> 10X Autonomous Evolution Hub, Meta-Remediator, and Vector Semantic Router.</span>
