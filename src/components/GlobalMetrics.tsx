...
export const GlobalMetrics: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      // Priority 1: Cloud Run Live Telemetry (The Cockpit Hub)
      // Priority 2: Public GitHub Mirror (The Cockpit Bridge)
      ...
      content: [
        {
          ...
          children: [
            ...
            {
              type: 'Text',
              props: { text: 'High-fidelity telemetry for Cockpit Agentic Operations (Sync: Cockpit Bridge active)', variant: 'caption' }
            }
          ]
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              children: [{ type: 'Metric', props: { label: 'Active Agents', value: active_agents.toString(), trend: 'Cockpit Nodes' } }]
            },
            {
              type: 'Card',
        ...
        },
        {
          ...
          children: [
            {
              type: 'Card',
              props: { title: 'Cockpit Fleet Distribution (Global Nodes)', icon: 'risk' },
    ...
    <div className="min-h-screen bg-slate-950 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <footer className="mt-12 pt-8 border-top border-slate-900 text-center text-slate-500 text-xs">
          © 2026 AgentOps Cockpit Cockpit Platform. Generated by Antigravity v2.0.17 Standard.
        </footer>
      </div>
    </div>
  );
